    ...
    public class TestOperators
    {
        ...
        public void TestVector6DOFApply()
        {
            ...
            (
                ...
                new Vector3(Mathf.Sin(0.5f), Mathf.Sin(1f), Mathf.Sin(1.5f))),
                result1
            );
            ...
            Assert.AreEqual(
                new Vector6DOF
            (
                new Vector3(Mathf.Sqrt(1f), Mathf.Sqrt(2f), Mathf.Sqrt(3f)),
                new Vector3(Mathf.Sqrt(0.5f), Mathf.Sqrt(1f), Mathf.Sqrt(1.5f))),
                result2
            );
        }
    }
