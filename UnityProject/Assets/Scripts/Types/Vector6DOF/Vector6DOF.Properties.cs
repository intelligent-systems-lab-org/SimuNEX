...
public partial class Vector6DOF
{
    ...
    public override int GetHashCode() => HashCode.Combine(linear, angular);
    ...
    public string this[string query]
    {
        set
        {
            ...
            var vectorValues = value.Trim('[', ']').Split(';');
