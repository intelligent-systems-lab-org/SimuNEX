...
namespace Eigen3MatrixTests
{
    public class TestConversions
    {
        ...
        {
            Matrix matrix = new(3, 3, new float[] { 1, 2, 3, 4, 5, 6, 7, 8, 9 }, true);
        ...
        {
            Matrix matrix = new(3, 3, new float[] { 1, 2, 3, 4, 5, 6, 7, 8, 9 });
        ...
        {
            Matrix matrix = new(2, 3, new float[] { 1, 2, 3, 4, 5, 6 });
            float[,] result = matrix.To2DArray();
        ...
        {
            Matrix matrix = new(3, 2, new float[] { 1, 2, 3, 4, 5, 6 });
            float[,] result = matrix.To2DArray();
