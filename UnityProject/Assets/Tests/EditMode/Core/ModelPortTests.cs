    ...
    public static class ModelPortTestCases
    {
        public static IEnumerable TestCases
        {
            get
            {
                ...
                yield return new TestCaseData(new ModelOutput<float[]>("float5") { data = new float[5] })
                    .Returns(5)
                    .SetName("FloatArray_5");
                yield return new TestCaseData(new ModelOutput<Vector6DOF>("vector6") { data = new Vector6DOF() })
                    .Returns(6)
                    .SetName("Vector6");
            }
        }
