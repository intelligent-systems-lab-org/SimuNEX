...
namespace ODESolverTests
{
    ...
    public abstract class SolverTests<TSolver> where TSolver : ODESolver, new()
    {
        ...
        public void ExponentialGrowth()
        {
            ...
            helpers.RunSimulationTest(ss, solverInstance, Mathf.Exp, Config);
        }
        ...
        public void LinearGrowth()
        {
            ...
            helpers.RunSimulationTest(ss, solverInstance, (float time) => 5f * time, Config);
        }
        ...
        public void HarmonicOscillator()
        {
            ...
            helpers.RunSimulationTest(ss, solverInstance, Mathf.Sin, Config);
        }
    }
}
